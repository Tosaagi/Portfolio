...
export default function Navbar() {
  return (
    <Disclosure as="nav">
      <div className="mx-auto px-2 sm:px-6 lg:px-8 border-gray-400 border-dotted border-b-1">
        <div className="relative flex h-16 items-center justify-between">
          ...
          <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-between">
            ...
            <div className="hidden sm:block">
              <div className="flex font-baloo justify-center space-x-4">
                {navigation.map((item) => (
                  <a
                    key={item.name}
                    href={item.href}
      ...
      <DisclosurePanel className="sm:hidden">
        <div className="space-y-1 px-2 pt-2 pb-3 font-baloo border-white border-1">
          {navigation.map((item) => (
            <DisclosureButton
              key={item.name}
              as="a"
